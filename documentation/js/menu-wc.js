                ...
                <li class="chapter">
                    ...
                    <li class="chapter">
                        ...
                        <ul class="links collapse " ${ isNormalMode ? 'id="components-links"' : 'id="xs-components-links"' }>
                            ...
                            <li class="link">
                                <a href="components/CategorisComponent.html" data-type="entity-link" >CategorisComponent</a>
                            </li>
                            <li class="link">
                            ...
                            <li class="link">
                                <a href="components/FoteerComponent.html" data-type="entity-link" >FoteerComponent</a>
                            </li>
                            <li class="link">
